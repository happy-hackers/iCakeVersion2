...
class App(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        self.listbox1 = tk.Listbox(self.main_frame,selectmode='multiple')
        self.listbox2 = tk.Listbox(self.main_frame,selectmode='multiple')
    ...
    def init_default_values(self):
        self.list_var1 = ["hello", "hi", "world"] 
        self.list_var2 = ["yes","no"]
        for item in self.list_var1:
            self.listbox1.insert(0,item)
        for item in self.list_var2:
            self.listbox2.insert(0,item)
    ...
    def move_to_right(self, only_one_item=False):
        ...
        if only_one_item:
            ...
            print self.listbox1.get(selection)
        else:
 ...
 #        result_list = sorted(list(set(right_value_list + left_selected_list)))
        ...
        self.list_var2 = self.list_var2.append(self.listbox1.get(selection))
